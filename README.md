...
A collection of scripts used in the comparative study of **Meshtastic** and **Reticulum** as data communication frameworks. The goal was to evaluate both platforms across key criteria, e.g. range, reliability, ease of deployment, throughput to inform a recommendation for data transmission.
